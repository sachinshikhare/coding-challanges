...
class MedianOf2SortedArraysTester{

    public static void main(String[] args) {
        int ar1[] = {1, 12, 15, 26, 38};
        int ar2[] = {2, 13, 17, 30, 45};
        System.out.println(MedianOf2SortedArrays.median(ar1, ar2));

        int arr1[] = {1, 12, 15, 26, 38};
        int arr2[] = {40, 45, 50, 52, 59};
        System.out.println(MedianOf2SortedArrays.median(arr1, arr2));

        int arr3[] = {2,4,7,12345,1000000000};
        int arr4[] = {100,101,299,688,7000,};
        System.out.println(MedianOf2SortedArrays.median(arr3, arr4));
    }
}